#!/usr/bin/env python3
"""Refresh Grok Image (grok-imagine-1.5-apimart) pricing from the public pricing payload.
...
PRIMARY = "grok-imagine-1.5-apimart"
OFFICIAL = ""
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Refresh Grok Image pricing")
    ...
    payload = {"id": PRIMARY, "alias": "grok-imagine-1.5-ext", "official": OFFICIAL,
